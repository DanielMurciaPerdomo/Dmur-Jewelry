    ...
    <div className="w-full max-w-2xl mx-auto">
      ...
      {items.length === 0 ? (
        <div className="text-center py-12">
          <p className="text-metallic-gold-600 dark:text-ocean-mist-400">Tu carrito está vacío.</p>
          <a
            href="/catalogo"
        ...
        <>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-between items-center border-t border-metallic-gold-300 dark:border-ocean-mist-800 pt-6">
            <button
              onClick={clear}
